...
👉 **[기본 MTP 피규어 위치]**
📌 *아래 피규어는 기본적인 Multi-Token Prediction 방식에서 한 번에 여러 토큰을 예측하는 구조를 시각화한 것이다.*

> **피규어 캡처: Standard MTP 구조**
...
👉 **[Medusa MTP 피규어 위치]**
📌 *아래 피규어는 Medusa 방식의 Multi-Token Prediction이 LM Head를 활용하여 병렬로 토큰을 예측하는 모습을 보여준다.*

> **피규어 캡처: Medusa MTP 구조**
...
👉 **[DeepSeek-V3 MTP 피규어 위치]**
📌 *아래 피규어는 DeepSeek-V3의 MTP가 Transformer 블록 내에서 어떻게 적용되는지를 보여준다.*

> **피규어 캡처: DeepSeek-V3 MTP 구조**
...
👉 **[DeepSeek-V3 MTP 코드 캡처 위치]**
📌 *아래 캡처는 DeepSeek-V3의 MTP가 Transformer 블록 내에서 어떻게 구현되었는지를 보여준다.*

> **코드 캡처: DeepSeek-V3 MTP 코드**
...
👉 **[H100 vs H800 비교 캡처 위치]**
📌 *위 이미지는 H100 vs H800 성능 비교를 보여준다.*
...
📌 Hopper 아키텍처 기반 FP8 Mixed Precision 적용 개요
